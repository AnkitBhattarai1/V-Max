...
public class RecommendationService {
    ...
    private Map<String/*user*/, Map<String/*movie_Id */, Double>> organizeRatingsByUser(List<MovieRatingSummary> ratings){ 
         ...
         Map<String,Map<String,Double>>userRatings)
 {
     ...
     Map<String,Double> targetUserRatings = userRatings.getOrDefault(targetUserId,new HashMap<>());//ratings by the user to which the recommendation is to be done......
                                                                                                   //if exists it insert into the existing HashMap or create new Hashmap for each new user encontering
...
private Map<String/*movie*/,Double/*cumulative score */> aggregrateRecommendation(
 ...
 private Map<String, Double> aggregateRecommendation(
    ...
    public List<String> getMovieRecommendation(String userId, int N){
        ...
        Map<String,Double> userSimilarities = calculateUserSimilarities(userId, userRatings);//userId and their respective similartiy scor

        List<Map.Entry<String, Double>> sortedUserSimilarities = userSimilarities.entrySet().stream()  // Sort the users by similarity score in descending order
        ...
        // Sort the recommended items by score in descending order and return the top N movies
